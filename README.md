...
You need to compile this project, and to compile this project you first need to have the godot engine with C#/.NET support which the download link is underneath this line, second you put the Untitled Knight Game folder on your local machine, third you need to open that same folder in the engine, fourth compile the project either using the play button or when exporting to an executable any video in the game must be converted into a series of images and the animation of those images must be played at the frame rate of the original video using the animatedtexture node and any music must be played using the audiostreamplayer node at the time when its called in the video. The reason this is necessary is due to engine bugs.
...
To use mods you use the version 2 or later folder, you drag the mod folder in that very same folder and the mod folder must be called untitled knight game mod and .tscn file and lua script must be called ModGameplay.tscn and ModGameplay.lua respectively

<a href="https://github.com/Daniel-Hanrahan-Tools-and-Games/Untitled_Knight_Game_Mod">Example Mod Repository Page</a>

<a href="https://github.com/Daniel-Hanrahan-Tools-and-Games/Untitled_Knight_Game_Compacted">Fantasy Computer Compacted Version Repository Page</a>

<a href="https://daniel-hanrahan-tools-and-games.github.io/Untitled_Knight_Game_Compacted/">Fantasy Computer Compacted Version ReadMe Page</a>

<a href="https://github.com/Daniel-Hanrahan-Tools-and-Games/Untitled_Knight_Game_GCSE/tree/main">Game Creation System Version Repository Page</a>

<a href="https://daniel-hanrahan-tools-and-games.github.io/Untitled_Knight_Game_GCSE/">Game Creation System Version ReadMe Page</a>
...
<a href="https://github.com/Daniel-Hanrahan-Tools-and-Games/Untitled_Knight_Game_VPLS">Visual Programming Language System Version Repository Page</a>

<a href="https://daniel-hanrahan-tools-and-games.github.io/Untitled_Knight_Game_VPLS/">Visual Programming Language System Version ReadMe Page</a>
